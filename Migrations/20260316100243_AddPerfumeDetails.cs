...
{
    /// <inheritdoc />
    public partial class AddPerfumeDetails : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandStory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VolumeOptions = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerfumeId = table.Column<int>(type: "int", nullable: false),
                    ChannelPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChannelProducts_Perfumes_PerfumeId",
                        column: x => x.PerfumeId,
                        principalTable: "Perfumes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChannelProducts_SalesChannels_SalesChannelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChannelOrders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChannelOrders_SalesChannels_SalesChannelId",
                        column: x => x.SalesChannelId,
                        principalTable: "SalesChannels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelOrders_OrderId",
                table: "ChannelOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelOrders_SalesChannelId",
                table: "ChannelOrders",
                column: "SalesChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelProducts_PerfumeId",
                table: "ChannelProducts",
                column: "PerfumeId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelProducts_SalesChannelId_PerfumeId",
                table: "ChannelProducts",
                columns: new[] { "SalesChannelId", "PerfumeId" },
                unique: true);
